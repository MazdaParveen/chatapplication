...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    const userId = 'snowy-base-5';
    const userToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoic25vd3ktYmFzZS01IiwiZXhwIjoxNzE2NTczODE1fQ.88XgQsec0gTJj3hsZQMBi7t9oZrTEorw6xO2Bub-r_c';
